...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename grad_mag \
    op interface \
    ports { grad_mag_address0 { O 19 vector } grad_mag_ce0 { O 1 bit } grad_mag_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'grad_mag'"
}
}
