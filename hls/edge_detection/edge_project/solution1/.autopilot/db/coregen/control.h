...
#define CONTROL_ADDR_LOW_THRESH_DATA  0x20
#define CONTROL_BITS_LOW_THRESH_DATA  32
#define CONTROL_ADDR_HIGH_THRESH_DATA 0x28
#define CONTROL_BITS_HIGH_THRESH_DATA 32
