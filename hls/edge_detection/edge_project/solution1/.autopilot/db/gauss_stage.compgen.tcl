...
set name edge_detect_mul_32ns_32ns_64_1_1
...
# RegSlice definition:
set ID 19
set RegSliceName edge_detect_regslice_both
set RegSliceInstName edge_detect_regslice_both_U
set CoreName ap_simcore_edge_detect_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
