...
architecture behave of edge_detect_control_s_axi is
    ...
    constant ADDR_HIGH_THRESH_DATA_0 : INTEGER := 16#28#;
    constant ADDR_HIGH_THRESH_CTRL   : INTEGER := 16#2c#;
    ...
    signal int_low_thresh      : UNSIGNED(31 downto 0) := (others => '0');
    signal int_high_thresh     : UNSIGNED(31 downto 0) := (others => '0');
