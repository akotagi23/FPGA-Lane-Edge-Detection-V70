...
entity edge_detect_start_for_sobel_stage_U0 is 
    generic (
...
architecture rtl of edge_detect_start_for_sobel_stage_U0 is

    component edge_detect_start_for_sobel_stage_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_edge_detect_start_for_sobel_stage_U0_ShiftReg : edge_detect_start_for_sobel_stage_U0_ShiftReg
    generic map (
...
entity edge_detect_start_for_sobel_stage_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end edge_detect_start_for_sobel_stage_U0_ShiftReg;

architecture rtl of edge_detect_start_for_sobel_stage_U0_ShiftReg is
